            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center py-6 justify-center w-full h-full bg-gradient-to-t from-MidNightBlack">
                <div className="bg-LightGray/10 w-[95%] h-[90%] px-4 py-2 rounded-xl overflow-hidden flex md:block">
                    <div className="flex items-center md:items-center md:justify-around">
                        <div className="">
                            <div className="">
                                <h1 className="text-3xl sm:text-4xl xl:text-5xl text-Snow font-bold">Hello, I'm JC!</h1>
                            </div>
                            <div className="">
                        ...
                        {/*<Link to='pages/contact.jsx' spy={true} smooth={true} duration={500} offset={-50} className="button">Talk to me</Link>*/}
                        </div>
                        <div className="w-48 h-52 relative hidden md:block">
                            <img className='absolute top-8 w-full h-full' src="images/pogi.png" alt="emoji" />
                        </div>
                    </div>
                </div>
